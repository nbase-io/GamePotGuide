...
dependencies {
    ...
    compile(name: 'gamepot-billing-onestore', ext: 'aar')
	compile(name: 'gamepot-channel-base', ext: 'aar')

	// google sigin & playgame [START]
	...
	compile(name: 'gamepot-logger', ext: 'aar')
	...
	compile(name: 'gamepot-bridge', ext: 'aar')
...
android {
	...
	defaultConfig {
		...
		resValue "string", "gamepot_push_icon","@mipmap/ic_launcher" // required (fcm)
		resValue "string", "gamepot_push_sicon","@mipmap/ic_launcher_round" // required (fcm)
		...
		resValue "integer", "gamepot_naver_cafeid", "000000" // optional (naver cafe sdk)
		resValue "string", "gamepot_naver_global_consumerkey", "" // optional (naver global cafe sdk)
		resValue "integer", "gamepot_naver_global_cafeid", "000000" // optional (naver global cafe sdk)
...
아래의 필수 값을 찾아 수장합니다. 아래 값들을 수정해야만 정상적으로 작동 됩니다.
...
| gamepot_push_icon                | 푸시 아이콘 (FCM)                                    |
| gamepot_push_sicon               | 푸시 아이콘 (FCM)                                    |
